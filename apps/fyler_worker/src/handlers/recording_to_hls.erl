...
-define(COMMAND(In,Out),
  "ffmpeg -i "++In++" -c:v libx264 -g 15 -keyint_min 15 -c:a libfdk_aac -ac 2 -ar 48000 -ab 192k -profile:v baseline -hls_time 10 -hls_list_size 0 "++Out).

-define(COMMAND2(In,Out),
  "ffmpeg -i "++In++" -c:v libx264 -g 2 -keyint_min 2 -an -profile:v baseline -level:v 3.0 -pix_fmt yuv420p  -r 2 -hls_time 10 -hls_list_size 0 "++Out).
